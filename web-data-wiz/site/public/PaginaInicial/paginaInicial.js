  ...
  function atualizarTextoComBaseNaResolucao() {
    ...
    if (larguraJanela < 768) { // Por exemplo, mude para a largura desejada
      ...
      spanTextoMissao.innerHTMTL = 'Capacitar e monitorar os sistema e garantir a segurança e eficiência e de seus dados por meio da monitoração avançada de computadores.';
      spanTextoVisao.innerHTMTL = 'Ser reconhecidos como o parceiros de confiança quando se trata de gerenciar o desempenho de computadores e coleta de dados.';
      spanTextoValores.innerHTMTL = 'Inovação. Excelência. Colaboração. Entender necessidades. Responsabilidade. Sustentáveis,';
    } else {
