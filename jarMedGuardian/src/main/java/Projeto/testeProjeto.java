...
public class testeProjeto {
    ...
    public static void main(String[] args) {
        ...
        Componente HD = new Componente("HD");
...
//            System.out.println(nomeApp);
        ...
        timer.scheduleAtFixedRate(new TimerTask() {
            public void run() {
                ...
                System.out.println(looca.getGrupoDeDiscos().getDiscos().get(0).getBytesDeLeitura().doubleValue() / conversorGb);
                ...
                for(int i = 0; i < bancoDeDados.selectComponente().size(); i++){
                    ...
                    switch (nomeComponente) {
                        ...
                        case "TEMPO DE ATIVIDADE" -> {
                            bancoDeDados.insertRegistro(Double.valueOf(dias), "Dias", 5);
                            bancoDeDados.insertRegistro(Double.valueOf(horas), "Horas", 5);
                            bancoDeDados.insertRegistro(Double.valueOf(minutos), "Minutos", 5);
                            bancoDeDados.insertRegistro(Double.valueOf(segundos), "Segundos", 5);
                        }
